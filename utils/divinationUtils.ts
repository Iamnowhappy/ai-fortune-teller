...
// This corrected version ensures all 64 hexagrams are unique and correctly mapped. The key is generated from the lines array (bottom-to-top) reversed.
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    "011100": { name: "택뢰수 (澤雷隨)", lines: ['yin', 'yin', 'yang', 'yang', 'yang', 'yin'] },
    "001110": { name: "산풍고 (山風蠱)", lines: ['yin', 'yang', 'yang', 'yang', 'yin', 'yin'] },
    ...
    "011001": { name: "택산함 (澤山咸)", lines: ['yang', 'yin', 'yin', 'yang', 'yang', 'yin'] },
    ...
    "100010": { name: "수산건 (水山蹇)", lines: ['yin', 'yang', 'yin', 'yin', 'yin', 'yang'] },
    ...
    "010100": { name: "풍수환 (風水渙)", lines: ['yin', 'yin', 'yang', 'yin', 'yang', 'yin'] },
...
export const getGanjiDate = (): string => {
    ...
    // FIX: Corrected index handling for negative results of the remainder operator.
