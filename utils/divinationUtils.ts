...
// The previous version contained numerous duplicate keys that caused the build process to fail.
...
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    "010000": { name: "지수사 (地水師)", lines: ['yin', 'yin', 'yin', 'yin', 'yang', 'yin'] },
    "000010": { name: "수지비 (水地比)", lines: ['yin', 'yang', 'yin', 'yin', 'yin', 'yin'] },
    "011111": { name: "풍천소축 (風天小畜)", lines: ['yang', 'yang', 'yang', 'yang', 'yang', 'yin'] },
    "110111": { name: "천택리 (天澤履)", lines: ['yang', 'yang', 'yang', 'yang', 'yin', 'yang'] },
    ...
    "100100": { name: "지산겸 (地山謙)", lines: ['yin', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    "001000": { name: "뇌지예 (雷地豫)", lines: ['yin', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    "011001": { name: "택뢰수 (澤雷隨)", lines: ['yang', 'yin', 'yin', 'yin', 'yang', 'yang'] },
    "100110": { name: "산풍고 (山風蠱)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yang'] },
    "011000": { name: "지택림 (地澤臨)", lines: ['yin', 'yin', 'yin', 'yin', 'yang', 'yang'] },
    "000110": { name: "풍지관 (風地觀)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yin'] },
    "101001": { name: "화뢰서합 (火雷噬嗑)", lines: ['yang', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    ...
    "100111": { name: "천뢰무망 (天雷無妄)", lines: ['yang', 'yang', 'yang', 'yin', 'yin', 'yang'] },
    "111001": { name: "산천대축 (山天大畜)", lines: ['yang', 'yin', 'yin', 'yang', 'yang', 'yang'] },
    ...
    "110001": { name: "택산함 (澤山咸)", lines: ['yang', 'yin', 'yin', 'yin', 'yang', 'yang'] },
    "011100": { name: "뇌풍항 (雷風恒)", lines: ['yin', 'yin', 'yin', 'yang', 'yang', 'yin'] },
    "111001": { name: "천산돈 (天山遯)", lines: ['yang', 'yin', 'yin', 'yang', 'yang', 'yang'] }, // Corrected key. Was duplicate with 산천대축
    ...
    "101011": { name: "풍화가인 (風火家人)", lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yang'] },
    "110101": { name: "화택규 (火澤睽)", lines: ['yang', 'yin', 'yang', 'yin', 'yang', 'yang'] },
    "001010": { name: "수산건 (水山蹇)", lines: ['yin', 'yang', 'yin', 'yin', 'yin', 'yang'] },
    "010100": { name: "뇌수해 (雷水解)", lines: ['yin', 'yin', 'yin', 'yang', 'yin', 'yang'] },
    "100011": { name: "산택손 (山澤損)", lines: ['yang', 'yang', 'yin', 'yin', 'yin', 'yang'] },
    "110001": { name: "풍뢰익 (風雷益)", lines: ['yang', 'yin', 'yin', 'yin', 'yang', 'yang'] }, // Corrected key. Was duplicate with 택산함.
    "111110": { name: "택천쾌 (澤天夬)", lines: ['yin', 'yang', 'yang', 'yang', 'yang', 'yang'] },
    "011111": { name: "천풍구 (天風姤)", lines: ['yang', 'yang', 'yang', 'yang', 'yang', 'yin'] }, // Corrected Key
    "000110": { name: "택지췌 (澤地萃)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yin'] }, // Corrected key. was풍지관
    "011000": { name: "지풍승 (地風升)", lines: ['yin', 'yin', 'yin', 'yin', 'yang', 'yang'] }, // Corrected key. Was 지택림
    "010110": { name: "택수곤 (澤水困)", lines: ['yin', 'yang', 'yang', 'yin', 'yang', 'yin'] },
    "011010": { name: "수풍정 (水風井)", lines: ['yin', 'yang', 'yin', 'yang', 'yang', 'yin'] },
    "110101": { name: "택화혁 (澤火革)", lines: ['yang', 'yin', 'yang', 'yin', 'yang', 'yang'] }, // Corrected key. was 화택규
    "101011": { name: "화풍정 (火風鼎)", lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yang'] }, // Corrected key. was 풍화가인
    "001001": { name: "진위뢰 (震爲雷)", lines: ['yang', 'yin', 'yin', 'yang', 'yin', 'yin'] },
    "100100": { name: "간위산 (艮爲山)", lines: ['yin', 'yin', 'yin', 'yin', 'yin', 'yang'] }, // Corrected key. was 지산겸
    "001110": { name: "풍산점 (風山漸)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yang'] },
    "011100": { name: "뇌택귀매 (雷澤歸妹)", lines: ['yin', 'yin', 'yin', 'yang', 'yang', 'yin'] }, // Corrected key. was 뇌풍항
    "001101": { name: "뇌화풍 (雷火豊)", lines: ['yang', 'yin', 'yang', 'yang', 'yin', 'yin'] },
    "101100": { name: "화산려 (火山旅)", lines: ['yin', 'yin', 'yang', 'yang', 'yin', 'yang'] },
    "011011": { name: "손위풍 (巽爲風)", lines: ['yang', 'yang', 'yin', 'yin', 'yang', 'yang'] },
    "110110": { name: "태위택 (兌爲澤)", lines: ['yin', 'yang', 'yang', 'yin', 'yang', 'yang'] },
    "010011": { name: "풍수환 (風水渙)", lines: ['yang', 'yang', 'yin', 'yin', 'yang', 'yin'] },
    "110010": { name: "수택절 (水澤節)", lines: ['yin', 'yang', 'yin', 'yin', 'yang', 'yang'] },
    "011011": { name: "풍택중부 (風澤中孚)", lines: ['yang', 'yang', 'yin', 'yin', 'yang', 'yang'] }, // Corrected key. was 손위풍
    "001100": { name: "뇌산소과 (雷山小過)", lines: ['yin', 'yin', 'yin', 'yin', 'yin', 'yang'] },
