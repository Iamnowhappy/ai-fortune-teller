...
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    "001011": { name: "뇌풍항 (雷風恒)", lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yin'] },
    ...
    "001110": { name: "풍뢰익 (風雷益)", lines: ['yin', 'yang', 'yang', 'yang', 'yin', 'yin'] },
    ...
    "001110": { name: "뇌택귀매 (雷澤歸妹)", lines: ['yin', 'yang', 'yang', 'yang', 'yin', 'yin'] },
    ...
    "010110": { name: "풍수환 (風水渙)", lines: ['yin', 'yang', 'yin', 'yang', 'yang', 'yin'] },
