...
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    "111011": { name: "풍천소축 (風天小畜)", lines: ['yang', 'yang', 'yin', 'yang', 'yang', 'yang'] },
    "110111": { name: "천택리 (天澤履)", lines: ['yang', 'yang', 'yang', 'yin', 'yang', 'yang'] },
    ...
    "100110": { name: "택뢰수 (澤雷隨)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yang'] },
    ...
    // FIX: Corrected key from "101101" to "101001" to match lines array and resolve duplicate key error.
    "101001": { name: "화뢰서합 (火雷噬嗑)", lines: ['yang', 'yin', 'yang', 'yin', 'yin', 'yang'] },
    "100101": { name: "산화비 (山火賁)", lines: ['yang', 'yin', 'yin', 'yang', 'yin', 'yang'] },
    ...
    // FIX: Removed comment that was no longer relevant after fixing the duplicate key. The key "101101" is correct for this entry.
    "101101": { name: "이위화 (離爲火)", lines: ['yang', 'yin', 'yang', 'yang', 'yin', 'yang'] },
    "001110": { name: "택산함 (澤山咸)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yin'] },
    ...
    "110001": { name: "산택손 (山澤損)", lines: ['yang', 'yin', 'yin', 'yin', 'yang', 'yang'] },
    ...
    "101110": { name: "택화혁 (澤火革)", lines: ['yin', 'yang', 'yang', 'yang', 'yin', 'yang'] },
    "011101": { name: "화풍정 (火風鼎)", lines: ['yang', 'yin', 'yang', 'yang', 'yang', 'yin'] },
    "100100": { name: "진위뢰 (震爲雷)", lines: ['yin', 'yin', 'yang', 'yin', 'yin', 'yang'] },
    "001001": { name: "간위산 (艮爲山)", lines: ['yang', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    // FIX: Corrected key from "011011" to "110001" to match lines array and resolve duplicate key error.
    "110001": { name: "풍산점 (風山漸)", lines: ['yang', 'yang', 'yin', 'yin', 'yin', 'yang'] },
    "110100": { name: "뇌택귀매 (雷澤歸妹)", lines: ['yin', 'yin', 'yang', 'yin', 'yang', 'yang'] },
    "101100": { name: "뇌화풍 (雷火豊)", lines: ['yin', 'yin', 'yang', 'yang', 'yin', 'yang'] },
    "001101": { name: "화산려 (火山旅)", lines: ['yang', 'yin', 'yang', 'yin', 'yin', 'yang'] },
    // FIX: Corrected key from "011011" to "110110" to match lines array and resolve duplicate key error.
    "110110": { name: "손위풍 (巽爲風)", lines: ['yang', 'yang', 'yin', 'yang', 'yang', 'yin'] },
