...
// The I_CHING_HEXAGRAMS object has been completely rebuilt to fix numerous errors
// in the previous version, including duplicate keys, incorrect names, and wrong line data.
// This corrected version ensures all 64 hexagrams are unique and correctly mapped.
// The key is the binary representation of the hexagram lines from bottom-to-top (yang='1', yin='0').
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    '100010': { name: '수뢰둔 (水雷屯)', lines: ['yin', 'yang', 'yin', 'yang', 'yin', 'yin'] },
    '010100': { name: '산수몽 (山水蒙)', lines: ['yin', 'yin', 'yang', 'yin', 'yang', 'yin'] },
    ...
    '100011': { name: '택뢰수 (澤雷隨)', lines: ['yang', 'yang', 'yin', 'yin', 'yin', 'yang'] },
    '110001': { name: '산풍고 (山風蠱)', lines: ['yang', 'yin', 'yin', 'yin', 'yang', 'yang'] },
    ...
    '001011': { name: '택산함 (澤山咸)', lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yin'] },
    ...
    '011001': { name: '산택손 (山澤損)', lines: ['yang', 'yin', 'yin', 'yang', 'yang', 'yin'] },
    '100110': { name: '풍뢰익 (風雷益)', lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yang'] },
    '011111': { name: '택천쾌 (澤天夬)', lines: ['yang', 'yang', 'yang', 'yang', 'yang', 'yin'] },
    '111110': { name: '천풍구 (天風姤)', lines: ['yin', 'yang', 'yang', 'yang', 'yang', 'yang'] },
    '000011': { name: '택지췌 (澤地萃)', lines: ['yang', 'yang', 'yin', 'yin', 'yin', 'yin'] },
    '110000': { name: '지풍승 (地風升)', lines: ['yin', 'yin', 'yin', 'yin', 'yang', 'yang'] },
...
const getHexagramFromLines = (lines: LineType[]): Hexagram => {
    // The key is generated from the lines array read from bottom to top.
