...
// The I_CHING_HEXAGRAMS object has been rebuilt with corrected data.
// The previous version contained numerous duplicate keys and incorrect line data.
// This corrected version ensures all 64 hexagrams are unique and correctly mapped. 
// The key is generated from the lines array (bottom-to-top).
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    '010100': { name: '수뢰둔 (水雷屯)', lines: [ 'yin', 'yin', 'yang', 'yin', 'yang', 'yin' ] },
    ...
    '111110': { name: '천택리 (天澤履)', lines: [ 'yin', 'yang', 'yang', 'yang', 'yang', 'yang' ] },
    ...
    '110100': { name: '택뢰수 (澤雷隨)', lines: [ 'yin', 'yin', 'yang', 'yin', 'yang', 'yang' ] },
    '001011': { name: '산풍고 (山風蠱)', lines: [ 'yang', 'yang', 'yin', 'yang', 'yin', 'yin' ] },
    '000110': { name: '지택림 (地澤臨)', lines: [ 'yin', 'yang', 'yang', 'yin', 'yin', 'yin' ] },
    '110000': { name: '풍지관 (風地觀)', lines: [ 'yin', 'yin', 'yin', 'yin', 'yang', 'yang' ] },
    '101100': { name: '화뢰서합 (火雷噬嗑)', lines: [ 'yin', 'yin', 'yang', 'yang', 'yin', 'yang' ] },
    '001101': { name: '산화비 (山火賁)', lines: [ 'yang', 'yin', 'yang', 'yang', 'yin', 'yin' ] },
    '001000': { name: '산지박 (山地剝)', lines: [ 'yin', 'yin', 'yin', 'yang', 'yin', 'yin' ] },
    '000100': { name: '지뢰복 (地雷復)', lines: [ 'yin', 'yin', 'yang', 'yin', 'yin', 'yin' ] },
    '111100': { name: '천뢰무망 (天雷無妄)', lines: [ 'yin', 'yin', 'yang', 'yang', 'yang', 'yang' ] },
    '001111': { name: '산천대축 (山天大畜)', lines: [ 'yang', 'yang', 'yang', 'yang', 'yin', 'yin' ] },
    '001100': { name: '산뢰이 (山雷頤)', lines: [ 'yin', 'yin', 'yang', 'yang', 'yin', 'yin' ] },
    '110011': { name: '택풍대과 (澤風大過)', lines: [ 'yang', 'yang', 'yin', 'yin', 'yang', 'yang' ] },
    ...
    '100011': { name: '뇌풍항 (雷風恒)', lines: [ 'yang', 'yang', 'yin', 'yin', 'yin', 'yang' ] },
    '111001': { name: '천산돈 (天山遯)', lines: [ 'yang', 'yin', 'yin', 'yang', 'yang', 'yang' ] },
    '100111': { name: '뇌천대장 (雷天大壯)', lines: [ 'yang', 'yang', 'yang', 'yang', 'yin', 'yang' ] },
    ...
    '101110': { name: '화택규 (火澤睽)', lines: [ 'yin', 'yang', 'yang', 'yang', 'yin', 'yang' ] },
    '010001': { name: '수산건 (水山蹇)', lines: [ 'yang', 'yin', 'yin', 'yin', 'yang', 'yin' ] },
    '100010': { name: '뇌수해 (雷水解)', lines: [ 'yin', 'yang', 'yin', 'yin', 'yin', 'yang' ] },
    '001110': { name: '산택손 (山澤損)', lines: [ 'yin', 'yang', 'yang', 'yang', 'yin', 'yin' ] },
    '011100': { name: '풍뢰익 (風雷益)', lines: [ 'yin', 'yin', 'yang', 'yang', 'yang', 'yin' ] },
    '110111': { name: '택천쾌 (澤天夬)', lines: [ 'yang', 'yang', 'yang', 'yang', 'yang', 'yin' ] },
    '111011': { name: '천풍구 (天風姤)', lines: [ 'yang', 'yang', 'yin', 'yang', 'yang', 'yang' ] },
    '110000': { name: '택지췌 (澤地萃)', lines: [ 'yin', 'yin', 'yin', 'yin', 'yang', 'yang' ] },
    '000011': { name: '지풍승 (地風升)', lines: [ 'yang', 'yang', 'yin', 'yin', 'yin', 'yin' ] },
    '110010': { name: '택수곤 (澤水困)', lines: [ 'yin', 'yang', 'yin', 'yin', 'yang', 'yang' ] },
    '010011': { name: '수풍정 (水風井)', lines: [ 'yang', 'yang', 'yin', 'yin', 'yang', 'yin' ] },
    '110101': { name: '택화혁 (澤火革)', lines: [ 'yang', 'yin', 'yang', 'yin', 'yang', 'yang' ] },
    '101011': { name: '화풍정 (火風鼎)', lines: [ 'yang', 'yang', 'yin', 'yang', 'yin', 'yang' ] },
    '100100': { name: '진위뢰 (震爲雷)', lines: [ 'yin', 'yin', 'yang', 'yin', 'yin', 'yang' ] },
    '001001': { name: '간위산 (艮爲山)', lines: [ 'yang', 'yin', 'yin', 'yang', 'yin', 'yin' ] },
    '011001': { name: '풍산점 (風山漸)', lines: [ 'yang', 'yin', 'yin', 'yang', 'yang', 'yin' ] },
    '100110': { name: '뇌택귀매 (雷澤歸妹)', lines: [ 'yin', 'yang', 'yang', 'yin', 'yin', 'yang' ] },
    ...
    '011010': { name: '풍수환 (風水渙)', lines: [ 'yin', 'yang', 'yin', 'yin', 'yang', 'yang' ] },
    '010110': { name: '수택절 (水澤節)', lines: [ 'yin', 'yang', 'yang', 'yin', 'yang', 'yin' ] },
    '011110': { name: '풍택중부 (風澤中孚)', lines: [ 'yin', 'yang', 'yang', 'yang', 'yang', 'yin' ] },
...
const getHexagramFromLines = (lines: LineType[]): Hexagram => {
    // Keys are generated from bottom-to-top, so the lines array needs to be reversed.
