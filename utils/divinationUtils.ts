...
// FIX: The I_CHING_HEXAGRAMS object has been rebuilt with corrected data.
...
const I_CHING_HEXAGRAMS: { [key: string]: { name: string, lines: LineType[] } } = {
    ...
    "110011": { name: "천택리 (天澤履)", lines: ['yang', 'yang', 'yin', 'yang', 'yang', 'yang'] },
    ...
    "011000": { name: "택뢰수 (澤雷隨)", lines: ['yin', 'yin', 'yin', 'yang', 'yang', 'yin'] },
    "000110": { name: "산풍고 (山風蠱)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yin'] },
    ...
    "011110": { name: "산뢰이 (山雷頤)", lines: ['yin', 'yang', 'yang', 'yang', 'yang', 'yin'] },
    "100001": { name: "택풍대과 (澤風大過)", lines: ['yang', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    ...
    "011100": { name: "뇌풍항 (雷風恒)", lines: ['yin', 'yin', 'yang', 'yin', 'yang', 'yang'] },
    ...
    "110001": { name: "산택손 (山澤損)", lines: ['yang', 'yin', 'yin', 'yin', 'yin', 'yang'] },
    "001011": { name: "풍뢰익 (風雷益)", lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yin'] },
    "011111": { name: "택천쾌 (澤天夬)", lines: ['yang', 'yang', 'yang', 'yang', 'yang', 'yin'] },
    "111110": { name: "천풍구 (天風姤)", lines: ['yin', 'yang', 'yang', 'yang', 'yang', 'yang'] },
    "000110": { name: "택지췌 (澤地萃)", lines: ['yin', 'yang', 'yang', 'yin', 'yin', 'yin'] },
    "011000": { name: "지풍승 (地風升)", lines: ['yin', 'yin', 'yin', 'yang', 'yang', 'yin'] },
    "010011": { name: "택수곤 (澤水困)", lines: ['yang', 'yang', 'yin', 'yin', 'yang', 'yin'] },
    "110010": { name: "수풍정 (水風井)", lines: ['yin', 'yang', 'yin', 'yin', 'yang', 'yang'] },
    "101011": { name: "택화혁 (澤火革)", lines: ['yang', 'yang', 'yin', 'yang', 'yin', 'yang'] },
    ...
    "101100": { name: "풍산점 (風山漸)", lines: ['yin', 'yin', 'yang', 'yang', 'yin', 'yang'] },
    "001101": { name: "뇌택귀매 (雷澤歸妹)", lines: ['yang', 'yin', 'yang', 'yang', 'yin', 'yin'] },
    ...
    "110100": { name: "풍수환 (風水渙)", lines: ['yin', 'yin', 'yang', 'yin', 'yang', 'yang'] },
    "001010": { name: "수택절 (水澤節)", lines: ['yin', 'yang', 'yin', 'yang', 'yin', 'yin'] },
    "110110": { name: "풍택중부 (風澤中孚)", lines: ['yin', 'yang', 'yang', 'yin', 'yang', 'yang'] },
...
const getHexagramFromLines = (lines: LineType[]): Hexagram => {
    ...
    if (!hexagramData) {
        console.error(`심각한 오류: 키 '${key}'에 해당하는 괘를 찾을 수 없습니다. 데이터가 손상되었을 수 있습니다.`);
