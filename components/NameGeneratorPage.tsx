...
export const NameGeneratorPage: React.FC<{ onBack: () => void; }> = ({ onBack }) => {
    ...
    const { result, isLoading, error: analysisError, runAnalysis, reset } = useAnalysis(analyzeName);
