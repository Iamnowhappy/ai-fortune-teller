    ...
    switch (selectedResult.type) {
        case 'face-reader':
            ...
            content = <AnalysisResultLayout {...props}
                ...
                freeContent={<div className="bg-slate-800/50 border border-slate-700 rounded-2xl shadow-lg p-6 sm:p-8"><h2 className="text-2xl sm:text-3xl font-bold text-cyan-300 mb-4 font-display">관상 분석 총평</h2><p className="text-slate-300 leading-relaxed whitespace-pre-wrap">{faceResult.overall_impression}</p></div>}
        ...
        case 'palm-reader':
             ...
             content = <AnalysisResultLayout {...props}
                ...
                freeContent={<div className="bg-slate-800/50 border border-slate-700 rounded-2xl shadow-lg p-6 sm:p-8"><h2 className="text-2xl sm:text-3xl font-bold text-cyan-300 mb-4 font-display">손금 분석 총평</h2><p className="text-slate-300 leading-relaxed whitespace-pre-wrap">{palmResult.overall_analysis}</p></div>}
        ...
        case 'impression-analyzer':
         ...
         case 'astrology-reader':
            ...
            content = <AnalysisResultLayout {...props}
                ...
                freeContent={<><div className="bg-slate-800/50 border border-slate-700 rounded-2xl shadow-lg p-6 sm:p-8 text-center"><h2 className="text-2xl sm:text-3xl font-bold text-cyan-300 mb-2 font-display">당신의 별자리</h2><p className="text-4xl sm:text-5xl font-bold text-white mb-4">{astrologyResult.zodiac_sign}</p><div className="flex justify-center gap-6 text-slate-300"><span>수호성: {astrologyResult.ruling_planet}</span><span>속성: {astrologyResult.element}</span></div></div><div className="space-y-6 mt-8"><div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6"><h3 className="text-xl font-bold text-white mb-3 font-display">성격 분석</h3><p className="text-slate-400 leading-relaxed">{astrologyResult.analysis.personality}</p></div></div></>}
        ...
        case 'tarot-reader':
            ...
            content = <>
                ...
                <AnalysisResultLayout {...props}
                    ...
                    freeContent={<div className="bg-slate-800/50 border border-slate-700 rounded-2xl shadow-lg p-6 sm:p-8"><h2 className="text-2xl sm:text-3xl font-bold text-cyan-300 mb-4 font-display">종합 리딩</h2><p className="text-slate-300 leading-relaxed whitespace-pre-wrap">{tarotResult.overall_reading}</p></div>}
         ...
         case 'juyeok-reader':
            ...
            content = <>
                ...
                <AnalysisResultLayout {...props}
                    ...
                    freeContent={<div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 sm:p-8"><h2 className="text-2xl sm:text-3xl font-bold text-cyan-300 mb-4 font-display">종합 해설</h2><p className="text-slate-300 leading-relaxed whitespace-pre-wrap">{juyeokResult.interpretation}</p></div>}
