...
Now, analyze the following cards:`;
            ...
            case 'juyeok':
                ...
                break;
            case 'yukhyo':
                prompt = `당신은 시공간의 기운을 읽어내는 육효점의 대가입니다. 사용자가 질문과 함께 이미지를 제공했습니다. 이미지가 상징하는 기운과 점을 치는 현재 시점의 기운을 결합하여 주역 64괘 중 하나를 도출하세요. 그 후, 육효의 원리에 따라 괘를 해석하여 질문에 대한 답을 주세요.

사용자의 질문: "${payload.question}"

해석 과정:
1.  **괘 도출**: 제공된 이미지가 담고 있는 상징, 색상, 분위기, 그리고 질문을 하는 현재 시점의 기운을 종합적으로 고려하여 가장 적합한 주역 64괘 하나를 직관적으로 선택합니다.
